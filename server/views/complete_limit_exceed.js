const complete_limit_template = `
    <body style="font-family: 'Poppins', sans-serif;">
        ...
        <div class="main_conatiner" style="padding: 2rem;">
            <h3 class="complete_limit_status" style="margin-bottom: 1rem;">100% Usage Exceeded</h3>
            <div class="subject_text" style="margin-bottom: 0.5rem;">
                ...
                <span class="subject_content">
                    <span>You have Used 100% of Usage Limit.
                    </span>
            </div>
            <div class="content_container" style="border: 1.25px solid #000;padding-bottom: 1rem;">
                ...
                <div class="content_container_content" style="padding: 0.2rem 2rem;">
                    ...
                    <p class="half_limit_status_text" style="margin-bottom: 1rem;margin-top: 1rem;">In case you need to issue more than the usage limit set for
                        you plan,
                    ...
                    <a style="text-decoration: none;" class="email_link" href="mailto: care@qwikcilver.com">care@qwikcilver.com</a>
...
`
export default complete_limit_template;
